...
function ZDebugCondition(reward_) : SecondaryCondition(reward_) constructor {
  // This debug condition can be set by hitting the Z key at any
  // time during the game. This is, obviously, ONLY for debugging

  static test = function() {
    return obj_ConditionMonitor.zKeyPressed;
  }

  static getText = function() {
    return "Press the Z key [long text to see how much room we have]";
  }
}
